  ...
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      subject: type === 'welcome'
        ? 'Bienvenue sur Volia'
        : 'Reinitialisation de votre mot de passe — Volia',
      html: type === 'welcome'
        ? `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px;background:#111;color:#fafafa;border-radius:12px">
            <h1 style="font-size:20px;margin:0 0 16px">Bienvenue sur Volia 🚀</h1>
            ...
            <a href="https://volia.fr/login" style="display:inline-block;margin-top:16px;padding:10px 24px;background:#7c3aed;color:#fff;border-radius:8px;text-decoration:none;font-size:14px;font-weight:600">Se connecter</a>
          </div>`
        : `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px;background:#111;color:#fafafa;border-radius:12px">
